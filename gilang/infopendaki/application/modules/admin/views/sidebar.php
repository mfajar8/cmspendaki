<nav class="sidebar-nav">
    <ul id="sidebarnav">
        ...
        <li>
            <a class="waves-effect waves-dark" href="<?php echo base_url()?>admin/tb_berita"><i class="mdi mdi-gauge"></i><span class="hide-menu">Berita</span></a>
        </li>
        <li>
            <a class="waves-effect waves-dark" href="<?php echo base_url()?>admin/tb_info"><i class="mdi mdi-gauge"></i><span class="hide-menu">Info</span></a>
        </li>
        <!-- //BATAS SATU MENU -->
